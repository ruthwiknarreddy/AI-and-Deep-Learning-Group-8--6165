...
disease_files, disease_labels, healthy_files = healthy_disease_split(glob.glob("/users/aflemis1/AI-and-Deep-Learning-Group-8--6165/dataset/PlantVillage/*"), "healthy")


temp_d, temp_dl, temp_h = healthy_disease_split(glob.glob("/users/aflemis1/AI-and-Deep-Learning-Group-8--6165/dataset/pumpkin/*"), "Healthy")
disease_files += temp_d
disease_labels += temp_dl
healthy_files += temp_h


temp_d, temp_dl, temp_h = healthy_disease_split(glob.glob("/users/aflemis1/AI-and-Deep-Learning-Group-8--6165/dataset/pear/Pear/leaves/*"), "healthy")
disease_files += temp_d
disease_labels += temp_dl
healthy_files += temp_h
